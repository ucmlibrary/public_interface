...
CAMPUS_LIST = [
 ...
 {'featuredImage': {'src': '/thumb-uc_merced.jpg',
                    'url': '/item/b1ce8bff-a992-46b8-91e5-71a09aaaab82/'},
  'id': '4',
  'name': 'UC Merced',
  'slug': 'UCM'},
 {'featuredImage': {'src': '/thumb-uc_riverside.jpg',
                    'url': '/item/2e852c0b-e194-43d8-945c-dcb381ba7fe0/'},
  'id': '5',
  'name': 'UC Riverside',
  'slug': 'UCR'},
 ...
 {'featuredImage': {'src': '/thumb-uc_sf.jpg',
                    'url': '/item/27b50a3a-9476-4ade-997a-ab875c1e2d9a/'},
  'id': '7',
  'name': 'UC San Francisco',
  'slug': 'UCSF'},
 {'featuredImage': {'src': '/thumb-uc_santabarbara.jpg',
                    'url': '/item/ark:/13030/kt3r29r74p/'},
  'id': '8',
